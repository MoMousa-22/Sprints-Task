...
abstract class AppLocalizations {
  ...
  /// No description provided for @mustIncludeAt.
  ///
  /// In en, this message translates to:
  /// **'Email must include @'**
  String get mustIncludeAt;
  ...
  /// No description provided for @addToCartMsg.
  ///
  /// In en, this message translates to:
  /// **'Added to cart!'**
  String get addToCartMsg;
